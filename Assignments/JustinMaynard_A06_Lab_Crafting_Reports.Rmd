...
```{r echo=FALSE, fig.cap = "Concentration of Ozone levels in 2018", fig.align='left', fig.dim = c(4,3), warning=FALSE}
...
```{r echo=FALSE, fig.cap = "Concentration of Ozone levels in 2019", fig.align='left', fig.dim = c(4,3), warning=FALSE}
Ozone_2019 <- epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(
    aes(x=month.abb[Month], y = Ozone)) + 
