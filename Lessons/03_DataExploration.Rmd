...
# setwd("/Users/justinmaynard/Fall_2023_EDE")
getwd()
```
...
#read.csv("/home/guest/Fall_2023_EDE/Data/Raw/USGS_Site02085000_Flow_Raw.csv",stringsAsFactors = TRUE)
...
str(USGS.flow.data) #shows data frame and objects in in
dim(USGS.flow.data) #shows rows and columns
length(USGS.flow.data) #shows rows
