...
* Non stationary - time series data that exhibits a significant upward or dwonward trend over time
** Seasonal data - time series variable exhibiting a repeating patters at regular intervals over time

* Stationarity process: probability laws that govern behavior of the process do not change over time (eg: distribution of observations at time 1 = distribution of observations at time 2)

* Partial autocorrelation function
**ACF measures linear dependence among process Yt and Yt-h
**PACF removes influence of all intermediate variables, will have only direct correlation between Yt and Yt-h

*Trend component
**long term tendency can increase (upward movement) or decrease (downward movement)
**can be linear or nonlinear

*Linear trend component
*We can write Yi = B0 + B1ti + ei
*Slope B1 and intercept B2 are unkown parameters, ei is the error term
*For each observation t remove the trend
*Ydetrendt = Yt - (B0 + B1t)

*Non linear trends
*Can nonlinear curves to data

*Seasonal component
*Short term regular wave like patterns, observed within 1 year

*4 components
*Trend, seasonality, cyclical, randomS
...
Measure of correlation between two adjacent values of the same variables
