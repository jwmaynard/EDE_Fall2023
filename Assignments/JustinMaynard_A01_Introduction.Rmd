...
analytics with a data science focus. Python experience includes an introductory data science course as well as a course in prescriptive analytics (mostly modeling). 
> Experience with R: I have taken multiple classes in R. Skills that I have learned include data management, various forms of regression and modeling, and data visualization. Specific skills include tidyverse packages (tidyr, ggplot, dplyr), glm's, classification models, and binomial models.
