...
#Use subset(dataframe, filter characteritics)
PMplot.faceted2 <- 
...
#Color = contour of shape
#Fill = color of the fill of boxplot, use color with boxplots
Nutrientplot3 <-
...
Nutrientplot4 <-
  ...
  geom_dotplot(aes(color = nutrient, fill = nutrient), binaxis = "y", binwidth = 1, 
               stackdir = "center", position = "dodge", dotsize = 2) #stack based on center position, position = dodge makes dots not overlay, goes to the side
print(Nutrientplot4)
...
# Ridgeline plot
#Used fill as wanted to fill below the curve
Nutrientplot6 <-
